...
<nav class="top-nav">
  ...
  <div class="nav-title">TABLE TENNIS MATCH</div>
  <div style="display:flex;align-items:center;gap:8px"> 
    <button class="save-btn" onclick="saveAndReport()">📊 SAVE &amp; REPORT</button>
    <button class="save-btn" style="margin-left:6px;background:#1e6c35;color:#fff;border:0;padding:8px 12px;border-radius:6px;cursor:pointer" onclick="window.open('tabletennis_matches_admin.php','_blank')">📚 Matches</button>
...
<div class="bottom-bar">
  ...
  <!-- Declare button removed; Save & Report will declare when appropriate -->
  ...
  <div style="display:flex;gap:8px;align-items:center">
    <button id="adminMarkWinnerA" class="bb-btn" onclick="toggleManualWinner('A')">🏆 A</button>
    <button id="adminMarkWinnerB" class="bb-btn" onclick="toggleManualWinner('B')">🏆 B</button>
  </div>
</div>
...
<!-- Style-capable SheetJS (xlsx-style) for Excel exports -->
